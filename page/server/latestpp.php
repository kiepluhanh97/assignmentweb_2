...
$result = $conn->query("SELECT templId, templUserid, templUpTime, templType, templName, templUrl, templDesc, templScore, templCategory, templNumberDownload, templImg1,templImg2,templImg3 FROM templ WHERE templType = 1 ORDER BY templUpTime DESC LIMIT 8");
