...
<body>
    <?php
        ...
        if (isset($_POST['login'])) {
            ...
            if ($password == $DataRow['userPassword']) {
                ...
                <div class="ui mini failed modal">
                    ...
                    <div class="actions">
                        <a class="ui red cancel inverted button" href="../page/login.php">Okay</a>
                    </div>
                </div>
                <?php
            }
    ...
    <div class="pusher">
        ...
        <div class="container">
            <form class="ui form" method="POST">
                ...
                <button class="ui primary ok inverted button" type="submit" name="login">Log In</button>
        ...
        <div class="ui mini modal">
            <div class="ui icon header">Error</div>
            <div class="content">
                <p>Username or Password must not be empty</p>
            </div>
            <div class="actions">
